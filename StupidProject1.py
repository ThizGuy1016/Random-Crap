...
days = soup.find(id='countdown-days').getText()
hours = soup.find(id='countdown-hours').getText()
minutes = soup.find(id='countdown-minutes').getText()
seconds = soup.find(id='countdown-seconds').getText()
